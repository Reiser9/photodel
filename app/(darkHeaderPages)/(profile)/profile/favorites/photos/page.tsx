...
const FavoritePhotos = () => {
    ...
    const { data, isLoading, isError } = useQuery({
        queryKey: ["myFavorites", "photo"],
        queryFn: () => getFavorites("photo"),
    });
    ...
    const deleteCheckedFavoritesPhotos = () => {
        deleteBulkFavorites({ ids: selectedIds }, () => {
            queryClient.invalidateQueries({ queryKey: ["myFavorites", "photo"] });
            setSelectedIds([]);
            setAction(null);
        });
    };
        ...
        <>
            ...
            >
                {isLoading ? (
                    ...
                    <NotContent text="Вы не добавили ни одного фото в избранное" />
                )}
            </ProfileActionsBlock>
