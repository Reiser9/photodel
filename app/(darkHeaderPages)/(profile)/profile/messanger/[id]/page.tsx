...
import { ArrowLeft, Send } from "@/shared/icons";
...
const MessangerDialogPage = () => {
    ...
    const { getChatById, getChatMessages, sendMessage } = useMessanger();
    ...
    const { title, picture, id: chatId } = data || {};
    ...
    return (
        <div className={styles.messangerContent}>
            <div className={styles.messangerTop}>
                ...
                <Link href={`/user/`} className={styles.messangerTopInfo}>
            ...
            <div className={styles.messangerDialogContent}>
                {messagesIsLoading ? (
                    ...
                    [...messages].reverse().map((data) => {
                        const { id, content, sender, createdAt } = data || {};
                        const {
                            avatarUrl,
                            firstName,
                            lastName,
                        ...
                        return (
                            ...
                            >
                                <Link
                                    href={`/user/${userId}`}
                                    className={styles.messangerDialogItemInfo}
                                >
                                    <span
                                        className={
                                ...
                                <div className={styles.messangerDialogItemText}>
                                    {content}
                                </div>
                            </div>
                        );
