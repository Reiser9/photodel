...
const TrainingsPage = () => {
    ...
    const { data, isLoading, isError } = useQuery({
        queryKey: ["trainings", page, sort, userSearchDebounce],
        queryFn: () =>
            getTrainings({
                page,
                sort,
    ...
    return (
        <div className={styles.profies}>
            ...
            >
                <p className={styles.profiesTitle}>Обучения</p>
                ...
                <div className={styles.profiesItemsInner}>
                    ...
                    {isLoading ? (
                        ...
                        <NotContent text="Обучений не найдено" />
                    )}
                </div>
